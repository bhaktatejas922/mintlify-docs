...
<AccordionGroup>
<Accordion title="edit_file: Modifying Code or Files with Precision">

The most critical tool for coding agents, `edit_file` enables precise file modifications:
...
```json
{
  ...
  "parameters": {
    "properties": {
      ...
      "instructions": "Clear description of the intended change",
      "code_edit": {
        "type": "string",
...
- Use special comments (Strongly Recommended: `// ... existing code ...`) to indicate unchanged sections - Morph works best with this format
...
**Best practices:**
- Preserve user query wording for better semantic matching
